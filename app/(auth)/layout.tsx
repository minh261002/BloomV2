                ...
                <Wrapper className='py-4'>
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                            <Link href="/">
                                <Image src="/images/logo.svg" alt="Shopee" width={130} height={50} className='object-contain' />
                            </Link>
                            <span className='text-black text-3xl font-medium mt-3 hidden md:block'>Đăng nhập</span>
                        </div>
