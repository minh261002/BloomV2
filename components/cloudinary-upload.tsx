    ...
    if (result.info && typeof result.info === "object") {
      ...
      if (Array.isArray(result.info)) {
        const newUrls = result.info
          .filter(
            (info) => info && typeof info === "object" && "secure_url" in info
          )
              ...
              >
                {currentValues.map((url, index) => {
                  ...
                  return (
                    <div
                      key={uniqueKey}
                      className="relative aspect-square rounded-lg overflow-hidden border border-gray-200 bg-gray-100 min-h-[120px]"
                    >
                      <Image
                        src={url}
              ...
              >
                <div className="flex flex-col items-center justify-center space-y-2">
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      PNG, JPG, GIF tối đa 5MB ({valuesRef.current.length}/
                      {maxFiles})
                    </p>
                  </div>
                </div>
